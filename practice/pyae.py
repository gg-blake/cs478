...
if __name__ == '__main__':
    ...
    msg = "abcd"
    n = ArithmeticEncoding(frequency_table=freq, save_stages=True)
    encoded_msg, encoder , interval_min_value, interval_max_value = n.encode(msg=msg,
                                                                              probability_table=n.probability_table)
    print(encoded_msg)
